            ...
            function change(type) {
                ...
                if(type == 'values') {
                    ta.value = "SELECT * WHERE { \n" +
                        ...
                        "VALUES ?ontid { \n" +
                        "OWL <?php echo $type; ?> <http://jagannath.pdn.cam.ac.uk/aber-owl/service/> " +
                        "<<?php echo $ontology; ?>> { <?php echo $query; ?> }\n" +
                        "} . \n\n" +
                    ...
                    ta.value = "SELECT * WHERE {\n" +
                        " # enter query here \n\n" +
                        " # filter on ?x \n" +
                        " FILTER ( ?x IN ( OWL <?php echo $type; ?> <http://jagannath.pdn.cam.ac.uk/aber-owl/service/> " +
                        "<<?php echo $ontology; ?>> { <?php echo $query; ?> } ) ) . \n" +
                        " }\n";
                }
            }
...
<body>
    <form name="sparqowl" action="sparqowl.php" method="POST">
        <textarea id="ta" name="sparqlquery" cols="150" rows="5"></textarea>
        ...
        <input type="checkbox" name="shortforms" value="use_shortforms" /> Use shortforms
        <input type="submit" />
    </form>
</body>
